...
if( !in_array(1, $userRoles) ){
	$actionCreate = \app\common\models\Action::find()->where(['action_match'=>'admin/owner/create'])->one();
	$actionUpdate = \app\common\models\Action::find()->where(['action_match'=>'admin/owner/update'])->one();
...
<div class="owner-form">
    ...
    <?= $form->field($model, 'owner_parent')->dropDownList($owners) ?>
